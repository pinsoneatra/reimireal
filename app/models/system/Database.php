...
class Database {
     ...
     */
    public function __construct($database_name = DB_NAME, $username = DB_USER, $password = DB_PASS, $host = DB_HOST) {
        self::$instance = $this;
    ...
    /* return just only mysql for datatable or some plugins sql */

    public function returnConn() {
        return $this->mysql;
    }

    public function issetProperty($property,$link) {
...
//            $this->system->redirect_to($link);
    ...
    final public static function instance($database_name = null, $username = null, $password = null, $host = 'localhost') {
        if (!isset(self::$instance)) {
            ...
            // self::$instance = new Database("kh846_db", "project", "pinsoneatra", "49.156.38.38");
        }
